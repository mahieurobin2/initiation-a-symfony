...
Axentix.DataDetection = (() => {
  ...
  var getOptions = function (obj, component, element) {
...
(() => {
  ...
  class Caroulix extends AxentixComponent {
    ...
    next() {
      ...
      var resetAutoplay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
Axentix.Forms = (() => {
  ...
  Axentix.updateInputs = function () {
    var inputElements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document.querySelectorAll('.form-material .form-field:not(.form-default) .form-control');
